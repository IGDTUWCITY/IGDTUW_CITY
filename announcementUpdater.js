...
function getSocietyName(page) {
    const nameMapping = {
        ...
        "./announcement_ai.html": "AI Society",
        ...
        "./announcement_assert.html": "Assert",
